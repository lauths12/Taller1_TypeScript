...
export var dataSeries = seriesData.map(function (serie) { return new Serie(serie.id, serie.name, serie.seasons, serie.channel, serie.description, serie.link, serie.image); });
